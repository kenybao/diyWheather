...
//		String customMapping = "/" + sign + "/";
	...
	private Map<String, Object> getDataMapInit(String modelName, String sign, String modelNameUpperCamel) {
		...
		data.put("BASE_PACKAGE", BASE_PACKAGE);
		data.put("MAPPER_PACKAGE", MAPPER_PACKAGE);
		data.put("MODEL_PACKAGE", MODEL_PACKAGE);
		data.put("SERVICE_PACKAGE", SERVICE_PACKAGE);
		data.put("SERVICE_IMPL_PACKAGE", SERVICE_IMPL_PACKAGE);
		data.put("CONTROLLER_PACKAGE", CONTROLLER_PACKAGE);
